...
<main>
	<h1 class="slideInDown animated">Add a new Employee or update there information <br> or remove them </h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			<fieldset>
				<label for="Device"><b>Office Department:</b></label>
			...
			<fieldset>
				<legend><span class="number">2</span> Employee's Info</legend>
				...
				<input type="text" name="email" id="email" placeholder="Contact...">
			</fieldset>
			<label>
