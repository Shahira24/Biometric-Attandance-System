...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Here are the Employee's daily logs</h1>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    ...
                    <select class="fing_sel" name="fing_sel" id="fing_sel">
                      <option value="0">All Student's</option>
                      <?php
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filter By Device Name:</b></label>
